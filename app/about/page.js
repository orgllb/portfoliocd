  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 px-8 py-12">
        ...
        <p className="text-[10px] text-[#999992] uppercase mb-4">About</p>
        <h1 style={{ fontFamily: 'var(--font-display)' }} className="text-[6rem] text-[#EBEBEB] leading-none mb-16">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <p className="text-[11px] text-[#b8b8b1] leading-loose mb-4">
            ...
            <p className="text-[11px] text-[#b8b8b1] leading-loose mb-10">
            ...
            <p className="text-[10px] text-[#8a8a84] uppercase mb-4">Expertise</p>
            <div className="flex flex-wrap gap-2 mb-10">
              {['Brand Identity', 'Art Direction', 'UI/UX Design', 'Typography', 'Motion', 'Creative Strategy'].map((skill) => (
                <span key={skill} className="text-[10px] text-[#a8a8a1] border border-[#222220] px-3 py-1 uppercase">
                  {skill}
                </span>
              ))}
            </div>

            <p className="text-[10px] text-[#8a8a84] uppercase mb-2">Currently</p>
            <p className="text-[11px] text-[#a8a8a1]">Available for new projects</p>
          </div>
