  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 px-8 py-12">
        <p className="text-[12px] text-[#999992] uppercase mb-4">Selected Work</p>
            ...
            <Link key={project.id} href={'/work/' + project.slug} className="group bg-[#111111] p-8 hover:bg-[#161614] transition-colors block">
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-[12px] text-[#8a8a84] uppercase">{project.category}</p>
                </div>
                <div className="text-right">
                  <p className="text-[12px] text-[#8a8a84] mb-1">{project.year}</p>
